...
# GIF paths
GIF_LISTENING = "listen.gif"
GIF_THINKING = "Think.gif"
GIF_SPEAKING = "speak.gif"
...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    gr.Markdown("# seeNsay: Conversational Image Recognition Chatbot")
    gr.Markdown("## Developed by INNOV8HERS ")
